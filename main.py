...
app.register_component_package('pydiet.cli.ingredients.flags')
app.register_component_package('pydiet.cli.ingredients.cost')
app.register_component_package('pydiet.cli.ingredients.nutrient')
app.root_route('home', 'MainMenu')

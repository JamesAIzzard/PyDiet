...
def validate_nutrient_data(nutrient_data: 'NutrientData') -> 'NutrientData':
    ...
    nutrient_data['nutrient_pref_units'] = quantity.quantity_service.validate_qty_unit(
        nutrient_data['nutrient_pref_units'])
    if nutrient_data['nutrient_pref_units'] not in quantity.quantity_service.get_recognised_mass_units():

...
#               'SearchIngredientsQuestionComponent')
...
# app.add_route('home.ingredients.edit.flags.ask_cycle_flags',
#               'AskCycleIngredientFlagsComponent')
# app.add_route('home.ingredients.edit.flags.set_flag',
#               'EditIngredientFlagComponent')
# app.add_route('home.ingredients.edit.cost_qty',
#               'EditIngredientCostQtyComponent')
# app.add_route('home.ingredients.edit.cost', 'EditIngredientCostComponent')
# app.add_route('home.ingredients.edit.density_volume',
#               'EditIngredientDensityVolumeComponent')
# app.add_route('home.ingredients.edit.density_mass',
#               'EditIngredientDensityMassComponent')
# app.add_route('home.ingredients.edit.set_density_question',
#               'EditIngredientDensityQuestionComponent')
# app.add_route('home.ingredients.edit.nutrients',
#               'EditIngredientNutrientMenuComponent')
# app.add_route('home.ingredients.edit.nutrients.nutrient_ingredient_qty',
#               'EditIngredientNutrientQtyComponent')
# app.add_route('home.ingredients.edit.nutrients.nutrient_mass',
#               'EditIngredientNutrientMassComponent')
# app.add_route('home.ingredients.edit.nutrients.search',
#               'IngredientNutrientSearchComponent')
# app.add_route('home.ingredients.edit.nutrients.search_results',
#               'IngredientNutrientSearchResultsComponent')
...
# app.add_route('home.ingredients.delete.search_results',
#               'IngredientSearchResultsComponent')
# app.add_route('home.ingredients.delete.confirm',
#               'ConfirmIngredientDeleteComponent')
...
# app.add_route('home.recipes.edit.serve_times',
#               'RecipeServeTimeEditorComponent')
# app.add_route('home.recipes.edit.serve_times.edit_interval',
#               'TimeIntervalEditorComponent')
...
# app.add_route('home.recipes.edit.ingredients.search',
#               'IngredientSearchComponent')
# app.add_route('home.recipes.edit.ingredients.search_results',
#               'IngredientSearchResultsComponent')
# app.add_route('home.recipes.edit.ingredients.set_ingredient_qty',
#               'EditIngredientQtyComponent')
# app.add_route('home.recipes.edit.ingredients.set_ingredient_variations',
#               'EditIngredientVarComponent')
...
# app.add_route('home.recipes.delete.search_results',
...
# app.add_route('home.goals.confirm_delete_day',
#               'ConfirmDayGoalsDeleteComponent')
...
# app.add_route('home.goals.edit_globals.edit_nutrient_targets',
#               'NutrientTargetEditorComponent')
# app.add_route('home.goals.edit_globals.edit_nutrient_targets.search_nutrient',

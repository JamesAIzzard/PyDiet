...
from pydiet.cli.components.ingredient_flag_editor import ingredient_flag_editor
...
app.register_component('ingredient_flag_editor', ingredient_flag_editor)
...
app.add_route(['home', 'ingredients', 'new', 'flags'], 'ingredient_flag_editor')
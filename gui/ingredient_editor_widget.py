...
class View(tk.Frame):
    def __init__(self, master, **kwargs):
        ...
        self._save_reset_frame.grid(row=0, column=0)
        ...
        self._basic_info_frame.grid(row=1, column=0, padx=5, pady=5)
...
class Controller(gui.ViewController):
    ...
    @staticmethod  # static until we implement, to shut intellisense up.
    def _on_save_clicked(event) -> None:
        """Handler for ingredient save."""
        print("save ingredient clicked")

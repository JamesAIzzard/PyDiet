...
class CostEditorController(gui.HasSubject, gui.SupportsDefinition, gui.SupportsValidity):
    ...
    def __init__(self, view: 'gui.CostEditorView', **kwargs):
        super().__init__(view=view, subject_type=model.cost.HasSettableCostPerQuantity, **kwargs)
    ...
    @property
    def subject(self) -> 'model.cost.HasSettableCostPerQuantity':
        return super().subject

    def set_subject(self, subject: 'model.cost.HasSettableCostPerQuantity') -> None:

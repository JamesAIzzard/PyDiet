...
class TestCanBeServedAt(TestCase):
    ...
    def returns_true_if_can_be_served_at_specified_time(self):
        """Checks the method returns true if the instance can be served at the specified time."""
        raise NotImplementedError

    def returns_false_if_cannot_be_served_as_specified_time(self):
        """Checks the method returns false if the instance cannot be served at the specified time."""
        raise NotImplementedError

...
class TestSubject(TestCase):
    ...
    def test_subject_returned_correctly(self):
        ...
        bqo = fx.IsQuantityOfBaseTestable(
            qty_subject=s,
...
class TestQuantityInG(TestCase):
    ...
    def test_returns_qty_in_g_if_set(self):
        ...
        bqo = fx.IsQuantityOfBaseTestable(qty_subject=mock.Mock(), quantity_data=fx.get_qty_data(qty_in_g=22))
    ...
    def test_raises_exception_if_not_set(self):
        ...
        bqo = fx.IsQuantityOfBaseTestable(qty_subject=mock.Mock(), quantity_data=fx.get_qty_data())
...
class TestRefQty(TestCase):
    ...
    def test_returns_ref_pc_mass_correctly(self):
        ...
        qo = fx.IsQuantityOfBaseTestable(

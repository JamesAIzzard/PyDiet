...
class TestQuantityInG(TestCase):
    ...
    def test_returns_qty_in_g_if_set(self):
        ...
        bqo = fx.HasQuantityOfTestable(subject=mock.Mock(), quantity_data=fx.get_qty_data(qty_in_g=22))
    ...
    def test_raises_exception_if_not_set(self):
        ...
        bqo = fx.HasQuantityOfTestable(subject=mock.Mock(), quantity_data=fx.get_qty_data())
...
class TestPrefUnit(TestCase):
    ...
    def test_pref_pc_unit_returned_correctly_if_pc_mass_configured(self):
        ...
        bqo = fx.HasQuantityOfTestable(
            subject=fx.HasReadableExtendedUnitsTestable(piece_mass_g=120),
            quantity_data=fx.get_qty_data(
                pref_unit='pc'
            )
        )
...
class TestRefQty(TestCase):
    ...
    def test_returns_ref_pc_mass_correctly(self):
        ...
        qo = fx.HasQuantityOfTestable(
            subject=fx.HasReadableExtendedUnitsTestable(piece_mass_g=150),

...
#         self.assertTrue(dg._nutrient_mass_goals["protein"].nutrient_mass_g == 18)
#
...
#         )
#         self.assertTrue(dg._nutrient_mass_goals["protein"].nutrient_mass_g == 180)
#
...
#         dg = goals.DayGoals()
#         mg = goals.MealGoals()
#         with self.assertRaises(goals.exceptions.UndefinedMealGoalNameError):

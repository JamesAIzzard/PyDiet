...
#         self.assertTrue(mg._nutrient_mass_goals["protein"].nutrient_mass_g == 18)
#
...
#         )
#         self.assertTrue(mg._nutrient_mass_goals["protein"].nutrient_mass_g == 180)
#
#
...
#         mg.undefine_nutrient_mass_goal("protein")
